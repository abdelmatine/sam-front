export const en = {
  ...
  about: {
    ...
    registry: {
      ...
      ce_detail: "Clinical Health & Safety",
  ...
  contact_info: {
    support_title: "Clinical Support",
  ...
  catalogue: {
    ...
    reset_search: "Reset Clinical Search",
    standards: {
      iso: "ISO 13485:2016",
      ce: "CE MEDICAL GRADE",
      fda: "FDA COMPLIANT"
  ...
  cart: {
    ...
    empty_desc: "No clinical devices have been synchronized with your selection module.",
    ref: "REF",
    ...
    encryption_protocol: "Clinical Encryption Protocol v4.0",
    protocol_notice: "Clinical Protocol Notice",
  ...
  product: {
    ...
    new: "New Technology",
    clinical_grade: "Clinical Grade Certified",
    add_to_cart: "Add to Cart",
    out_of_stock: "Out of Stock",
    ai_assistant: "AI Assistant",
    ai_desc: "Simplify complex specifications into a clinical summary.",
    ai_btn: "Expert Clinical Summary",
    ai_new: "New Analysis",
