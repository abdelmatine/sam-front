export const fr = {
  ...
  checkout: {
    title: "Terminal d'Acquisition Technique",
    subtitle: "Complétez le protocole technique pour finaliser l'acquisition de votre équipement.",
    module_id: "TERMINAL_ACQUISITION_v4.5",
    shipping_details: "Protocole Logistique",
    payment_method: "Synchronisation de Paiement",
    order_review: "Révision Technique",
    place_order: "Exécuter l'Acquisition",
    first_name: "Prénom",
    last_name: "Nom",
    email: "Email Professionnel",
    phone: "Ligne de Contact Technique",
    address: "Adresse Postale",
    city: "Ville",
    postal_code: "Code Postal",
    country: "Région",
    card_holder: "Nom du Titulaire",
    card_number: "ID Carte Technique",
    expiry: "EXP MM/AA",
    cvv: "Protocole CVV",
    submitting: "Exécution de la Synchronisation...",
  ...
  wishlist: {
    ...
    diag_id: "ID Diagnostic : NO-PRIORITY-REF",
    empty_title: "Aucune Priorité Identifiée",
    empty_desc: "Votre archive technique est actuellement vide. Explorez notre catalogue.",
    stability: "STABILITÉ SYSTÈME : 99.9%",
    iso_cert: "CERTIFIÉ ISO 13485",
    units: "Unités"
  },
  product: {
    ...
    selection_updated: "Selection Mise à Jour",
