    ...
    <section className="py-32 bg-slate-50/50 dark:bg-slate-950 text-foreground overflow-hidden relative border-y">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4 uppercase tracking-tighter text-slate-900 dark:text-white">
            Specialized <span className="text-primary">Categories</span>
          </h2>
          <p className="text-slate-500 dark:text-slate-400 text-sm max-w-xl font-medium italic leading-relaxed">
        ...
        >
          ...
          <motion.div 
            ...
            className="lg:col-span-7 relative group overflow-hidden border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900 clinical-shadow"
          >
            <Link href="/shop?category=respiratory" className="block h-full min-h-[400px]">
              ...
              <div className="absolute bottom-10 left-10 right-10">
                ...
                <h3 className="text-3xl md:text-4xl font-bold mb-4 uppercase tracking-tight text-white">Respiratory Care</h3>
                <p className="text-white/70 text-sm mb-8 max-w-md font-medium italic">
          ...
          <div className="lg:col-span-5 grid grid-rows-2 gap-6">
            ...
            <motion.div 
              variants={itemVariants}
              className="relative group overflow-hidden border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900 clinical-shadow"
            >
              <Link href="/shop?category=others" className="block h-full min-h-[250px]">
                {accessoriesImage && (
                  <Image 
                    ...
                    alt="Protective Gear"
                    fill
                    className="object-cover transition-all duration-1000 group-hover:scale-105 opacity-70 group-hover:opacity-100"
                    data-ai-hint="medical gloves apparel"
                  />
                )}
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-slate-950/20 to-transparent" />
                <div className="absolute bottom-8 left-8">
                  <h3 className="text-2xl font-bold mb-2 uppercase tracking-tight text-white">Protective Gear</h3>
                  <p className="text-white/70 text-xs mb-6 font-medium italic">Nitrile Gloves & Medical Apparel</p>
            ...
            >
              <Link href="/shop?category=accessories" className="block h-full min-h-[250px]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-slate-950/20 to-transparent" />
                <div className="absolute bottom-8 left-8">
                  <h3 className="text-2xl font-bold mb-2 uppercase tracking-tight text-white">Clinical Supplies</h3>
                  <p className="text-white/70 text-xs mb-6 font-medium italic">Calibration Kits & Filters</p>
                  <div className="h-[2px] w-12 bg-primary group-hover:w-24 transition-all" />
                </div>
              </Link>
            </motion.div>
