...
const MobileMenu = ({ cartQuantity, wishlistCount }: MobileMenuProps) => {
          ...
          <div className="mb-10">
            ...
            <Accordion type="single" collapsible className="w-full space-y-6">
              <AccordionItem value="shop" className="border-none">
                <AccordionTrigger className="p-0 hover:no-underline font-headline font-bold text-lg uppercase tracking-tighter hover:text-primary transition-colors">
                  {t.nav.catalogue}
                </AccordionTrigger>
              ...
              <div className="space-y-6 pt-4">
                <SheetClose asChild>
                  <Link href="/services" className="block text-lg font-headline font-bold uppercase tracking-tighter hover:text-primary transition-colors">{t.nav.services}</Link>
                </SheetClose>
                <SheetClose asChild>
                  <Link href="/about" className="block text-lg font-headline font-bold uppercase tracking-tighter hover:text-primary transition-colors">{t.nav.about}</Link>
                </SheetClose>
                <SheetClose asChild>
                  <Link href="/contact" className="block text-lg font-headline font-bold uppercase tracking-tighter hover:text-primary transition-colors">{t.nav.contact}</Link>
                </SheetClose>
              </div>
            </Accordion>
          </div>
