  ...
  return (
    <html lang="fr" suppressHydrationWarning>
      <head>
        ...
        {/* Creative Clinical Typography: Outfit for Headlines, Inter for Body */}
        <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@400;600;700;800&family=Inter:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&family=Noto+Sans+Arabic:wght@400;700&display=swap" rel="stylesheet" />
      </head>
