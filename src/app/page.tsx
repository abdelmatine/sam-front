  ...
  return (
    <main className="flex flex-col min-h-screen bg-white">
      ...
      <section className="py-32 bg-slate-900 relative overflow-hidden">
        ...
        >
          <motion.div variants={itemVariants} className="inline-block p-4 bg-primary/10 rounded-full border border-primary/20 mb-8">
            <Mail className="h-8 w-8 text-primary" />
          </motion.div>
          
          <motion.h2 variants={itemVariants} className="text-3xl md:text-5xl font-bold text-white mb-6 uppercase tracking-tighter">
            Professional Updates
          </motion.h2>
          
          <motion.p variants={itemVariants} className="text-slate-400 mb-12 text-sm md:text-base font-medium italic leading-relaxed">
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto">
            <input 
              type="email" 
          ...
          <motion.div variants={itemVariants} className="mt-12 flex items-center justify-center gap-3 text-slate-500">
