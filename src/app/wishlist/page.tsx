  ...
  return (
    <main className="min-h-screen flex flex-col pt-24 pb-20 bg-background">
      ...
      <div className="container mx-auto px-4 flex-1">
        <div className="flex items-center justify-between mb-12 border-l-4 border-primary pl-6">
          <div>
            ...
            <AnimatePresence>
              {items.map((item, index) => (
                <motion.div
                  ...
                  className="bg-card border rounded-none overflow-hidden group transition-all hover:shadow-2xl hover:border-primary/40 flex flex-col h-full"
                >
